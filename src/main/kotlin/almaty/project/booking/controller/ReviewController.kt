...
class ReviewController(private val reviewService: ReviewService) {
    ...
    @PostMapping
    fun addReview(@RequestBody command: AddReviewCommand): Mono<Review> {
